        ...
        <ul class="navbar-nav ml-auto">
          <li class="nav-item mx-0 mx-lg-1">
            ...
            <div class="dropdown-menu">
               <a href="/admin/alumnis/create" class="dropdown-item">REGISTRATION</a>
             </div>          
          ...
          <li class="nav-item mx-0 mx-lg-1 dropdown">
            ...
            <div class="dropdown-menu">
                ...
                <?php $batches=App\Models\Alumni::orderBy('batch', 'ASC')->distinct()->get(['batch']);      ?>
          ...
          <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#contact">PUBLICATIONS</a>
          </li>

            <li class="nav-item mx-0 mx-lg-1">
            <a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#contact">Blog</a>
          </li>
